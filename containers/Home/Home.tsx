  ...
  const serviceData = [
    {
      ...
      tech: "JQuery",
      description:
        "A leading e-learning platform in US, my responsibility was to ensure the front-office match the template and content",
    ...
    // },
    {
      ...
      description:
        "Website manage store and cards discount of store, with many package service, my responsibility was to ensure the front-office match the template and content, make sure correct flow and functional of web",
            ...
            <StyledInfo className="col-12">
              <StyledWrapperInfo className="row">
                ...
                <StyledWrapperContent className="col-sm-12 col-lg-9">
                  <StyleBanner className="row">
                    <StyledBannerContent className="col-sm-12 col-lg-12">
                      ...
                      <StyledSubTitleContent>
                        <p>
                          {" "}
                          &lt;<span className="code">code</span>&gt; I build
                          website &lt;/<span className="code">code</span>&gt;
                        </p>
                  ...
                  <Achievement achieves={contentData.achieves} />
